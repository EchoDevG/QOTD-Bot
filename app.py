...
WHEN = time(17, 30, 0)
openai.api_key = "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"
PERSPECTIVE_API_KEY = "AIzaSyDIkbK85oqqxzHpm5WYBLrmH4AITklW5ag"
# channel_id = 888352659562721291 # Put your channel id here
channels = []
...
async def weather(ctx, arg=352792):
    response = requests.get(f"http://datapoint.metoffice.gov.uk/public/data/val/wxfcs/all/json/{arg}/?res=3hourly&key=57bfdba9-d618-47e5-bb01-2c43f9906ab3")
...
async def lengthen(ctx, arg):
    ...
    for word in words:
        ...
        headers = {
	    "X-RapidAPI-Key": "dd11551877msh1d61d301626cc01p11325bjsnb74d5ccde804",
